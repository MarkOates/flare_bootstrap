...
private:
   ...
   static Shader *__get_standard_compound_shader()
   {
      ...
      standard_compound_shader = new Shader("data/shaders/standard_compound_vertex_for_shadows.glsl", "data/shaders/standard_compound_fragment_for_shadows.glsl");
...
public:
   ...
   My3DProject(Display *display)
      ...
      , cubemap_shader("data/shaders/cube_vertex_for_shadows.glsl", "data/shaders/cube_fragment_for_shadows.glsl")
